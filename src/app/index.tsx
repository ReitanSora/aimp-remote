...
import { FlatList, StyleSheet, Text, ToastAndroid, TouchableNativeFeedback, useWindowDimensions, View } from 'react-native';
  ...
  useEffect(() => {
    ...
    const playlistInfo = async () => {
      try {
        ...
        console.log('Error fetching playlists data', e);
      } finally {
        setIsLoading(false);
      }
    };
