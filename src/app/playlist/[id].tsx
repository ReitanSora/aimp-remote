...
import { PlaylistInfoProps, PlaylistStatsProps, PlaylistItemType } from '@/types/IPlaylistDetails';
...
export default function Playlist() {
  ...
  const renderItem = useCallback(({ item }: { item: PlaylistItemType }) => <PlaylistItem item={item} onPress={() => handlePlayItem(item.index.toString())} />, [handlePlayItem]);
        ...
        <>
          ...
          <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <FlatList
              ...
              ListHeaderComponent={playlistInfo && playlistStats ? <PlaylistDetailsHeader playlistInfo={playlistInfo} playlistStats={playlistStats} /> : <Text>Loading...</Text>}
