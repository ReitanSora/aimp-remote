...
export default function SoundWave({ wavesContainerGap, waveWidth, waveHeightOdd, waveHeightEven, waveBackground, animate }: SoundWaveProps) {
  ...
  useEffect(() => {
    heightOdd.value = withDelay(100, withRepeat(withTiming(waveHeightOdd, { duration: 500 }), -1, true));
    heightEven.value = withDelay(500, withRepeat(withTiming(waveHeightEven, { duration: 500 }), -1, true));
  }, [heightEven, heightOdd, waveHeightEven, waveHeightOdd]);
