...
import Svg, { Defs, RadialGradient, Stop, G, Circle, Path, Text, SvgProps } from 'react-native-svg';

const SVGComponent = (props: SvgProps) => (
  <Svg viewBox="0 0 768 256" {...props}>
    <Defs>
    ...
    <G id="Text" fill="#FFFFFF">
      ...
      <Text x={680} y={180} textAnchor="end" fontFamily="Tahoma" fontSize="32px" fontStyle="italic">
        {'ENJOY THE MUSIC!'}
      </Text>
    </G>
  </Svg>
