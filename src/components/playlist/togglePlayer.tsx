      ...
      <TouchableNativeFeedback background={TouchableNativeFeedback.Ripple('rgba(139, 139, 139, 0.5)', false)} useForeground onPress={() => router.navigate('/(player)')}>
        <View style={styles.toggleInside}>
            ...
            <View style={styles.songInfo}>
              ...
              <Text
                style={[
                  styles.text,
                  {
                    color: appColor === '#8B8B8B' ? '#FFF' : '#C6C6C6',
                    fontSize: 12,
                  },
                ]}
                numberOfLines={1}
          ...
          <View style={styles.songControl}>
            <NormalButton rippleColor="rgba(139, 139, 139, 0.5)" onPress={() => handlePause()} IconSet={MaterialCommunityIcons} iconName={playerState === 'play' ? 'pause' : 'play'} iconSize={36} />
          </View>
        </View>
